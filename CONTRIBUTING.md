...
各単元 `plan.md` の **準備物** 欄は、Drive 上の教材台帳（`理科マイノート/教材台帳.xlsx`）の ID と Drive リンクを併記します。
...
- **ID（B-/C-/K-/L-）を必ず併記** — 後から台帳と突き合わせやすくするため
- **チェックボックス（`- [ ]` / `- [x]`）** で授業前後に状態管理
- **絵文字** は分かりやすさ優先（📄 プリント / 🎞️ 動画 / 🎤 スライド / 📊 評価）
- 詳細は [docs/resources/kyozai-daichou.md](docs/resources/kyozai-daichou.md) を参照